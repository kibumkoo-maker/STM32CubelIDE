...
void delay_us(uint16_t us)
{
   ...
   __HAL_TIM_SET_COUNTER(&htim2, 0); // initislize counter to start from 0
    while((__HAL_TIM_GET_COUNTER(&htim2))<us); // wait count until us
...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  HAL_GPIO_WritePin(TRIG1_GPIO_Port, TRIG1_Pin, HIGH);
	      ...
	      HAL_GPIO_WritePin(TRIG1_GPIO_Port, TRIG1_Pin, LOW);
	      uint32_t t1 = echo1();
	      if(t1 != 0) printf("Distance1 = %d(mm)\r\n", (int)(17 * t1 / 100));
	      else printf("Out of Range 1!\r\n");
	      ...
	      HAL_GPIO_WritePin(TRIG2_GPIO_Port, TRIG2_Pin, LOW);
	      uint32_t t2 = echo2();
	      if(t2 != 0) printf("Distance2 = %d(mm)\r\n", (int)(17 * t2 / 100));
	      else printf("Out of Range 2!\r\n");
